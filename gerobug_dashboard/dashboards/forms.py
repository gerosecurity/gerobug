...
class CompanyIdentityForm(forms.Form):
    company_logo = forms.FileField(widget=forms.FileInput(attrs={'id':'company_logo', 'placeholder': 'Company Logo (.png)', 'style': 'width: 100%;', 'class': 'form-control', 'accept': '.png'}),label="Company Logo (.png)",validators=(validate_is_image,), required=False)
