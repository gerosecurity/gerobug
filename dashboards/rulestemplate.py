...
<p>We thank you for your effort and give you permission to share or publish the vulnerabilities you discovered. You can consult the disclosure statement below:</p>
                    <ul>
                        ...
                        <li>You do not interact with an individual account (which includes modifying or accessing data
                            from the account) if the account owner has not consented to such actions.</li>
                        ...
                        <li>You are required to act in good-faith security research to prevent disruptions and produce
                            minimum to no impact for Gerobug and other Gerobug users.</li>
                        ...
                        <li>You do not intentionally violate any other applicable laws or regulations, including (but
                            not limited to) laws and regulations prohibiting the unauthorised access to data.</li>
                        ...
                        <li>Gerobug reserves the right to decide whether submitted reports are allowed to be published
                            to the public or not.</li>
...
<p>By disclosing flaws in our services, security researchers help us keep Gerobug's system and data secure, and we thank them for their assistance. Gerobug reserves the right to decide whether to offer monetary rewards for such reports based on risk, impact, and other considerations. You must initially satisfy the following criteria in order to be eligible for a bounty:</p>
                    <ul>
                        <li> Before submitting any reports, you must read and accept the terms and conditions on the Gerobug Bug Bounty portal. </li>
                        ...
                        <li>
                        Follow our responsible disclosure guidelines (see above).
                        </li>
                        ...
                        <li>One of the below-listed goods or services must be the subject of an issue in your report (see "In Scope" and "Out Scope").
</li>
                        <li>Below is a list of potential security concerns that we expressly do not include (see "In Scope" and "Out Scope").
</li>
                        <li>One issue per report; submit your report using our "Report a Security Vulnerability" form and provide any changes. Please do not make direct contact with staff members or use any other ways to submit</li>
                        ...
                        <li>Gerobug employs a risk-based method analysis together with the Common Vulnerability Scoring System (CVSS) calculator to assess the severity of the problem.</li>
                        <li>We determine bounty amounts based on a variety of factors, including (but not limited to)
                            impact, ease of exploitation and quality of the report.</li>
                        ...
                        <liIn the event of duplicate reports, the first researcher to submit a legitimate Bug Bounty Report will get the compensation, at the discretion of Gerobug. (Gerobug is not compelled to disclose the specifics of the Bug Bounty Report; Gerobug reserves the right to assess whether a Bug Bounty Report is a duplicate.) Only one person is compensated for a given bounty.</li>
                        <li>Reports may be published at our discretion (and accompanying updates).</li>
                    </ul>
"""
inscope_templates = """
<ul>
                        <li>For security bug report, please create report through email , including proof of
                            concept that contains: step by steps, screenshoot and the remediation. Don't forget to
                            attach proof of concept video to reproduce the vulnerabilty.</li>
...
outofscope_templates = """
                    <pre><code>- 3rd Party Apps (Microsite, Wordpress, CMS, Blog, Even Inside Gerobug.com/* ,etc. ) <br>- 3rd Party Plugins</code></pre>
